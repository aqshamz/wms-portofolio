...
func registerInboundRoutes(api *gin.RouterGroup, controller *controller.Controller, requireSession gin.HandlerFunc) {
	...
	group.PUT("/purchase-orders/:id", controller.UpdatePurchaseOrder)
	group.POST("/purchase-orders/:id/lines", controller.AddPurchaseOrderLine)
	group.PUT("/purchase-orders/:id/lines/:line_id", controller.UpdatePurchaseOrderLine)
	group.DELETE("/purchase-orders/:id/lines/:line_id", controller.DeletePurchaseOrderLine)
	...
	group.PUT("/orders/:id", controller.UpdateInboundOrder)
	group.POST("/orders/:id/lines", controller.AddInboundOrderLine)
	group.PUT("/orders/:id/lines/:line_id", controller.UpdateInboundOrderLine)
	group.DELETE("/orders/:id/lines/:line_id", controller.DeleteInboundOrderLine)
	...
	group.PUT("/receipts/:id", controller.UpdateReceipt)
