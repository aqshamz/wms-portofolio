...
type ReceiptLine struct {
	...
	ReceivedBaseQty     string    `gorm:"column:received_base_qty;type:numeric(20,6);not null"`
	RejectedBaseQty     string    `gorm:"column:rejected_base_qty;type:numeric(20,6);not null;default:0"`
