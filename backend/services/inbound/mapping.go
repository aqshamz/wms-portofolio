...
func mapPurchaseOrder(row repository.PurchaseOrderRow) dto.PurchaseOrderResponse {
	return dto.PurchaseOrderResponse{ID: row.ID, OwnerID: row.OwnerID, OwnerCode: row.OwnerCode, VendorID: row.VendorID, VendorCode: row.VendorCode, VendorName: row.VendorName, WarehouseID: row.WarehouseID, WarehouseCode: row.WarehouseCode, BusinessDate: dateText(row.BusinessDate), PurchaseOrderNo: row.PurchaseOrderNo, OrderedAt: row.OrderedAt, ExpectedArrivalAt: row.ExpectedArrivalAt, StatusCode: row.StatusCode, Notes: row.Notes, SupersedesPurchaseOrderID: row.SupersedesPurchaseOrderID, SuccessorPurchaseOrderID: row.SuccessorPurchaseOrderID, VersionNo: row.VersionNo, CreatedAt: row.CreatedAt}
}
func mapPurchaseOrderLine(row repository.PurchaseOrderLineRow) dto.PurchaseOrderLineResponse {
	...
	return dto.PurchaseOrderLineResponse{ID: row.ID, LineNo: row.LineNo, ItemID: row.ItemID, ItemCode: row.ItemCode, ItemName: row.ItemName, OrderedQty: row.OrderedQty, UOMConversionToBase: row.UOMConversionToBase, OrderedBaseQty: row.OrderedBaseQty, BaseUOMID: row.BaseUOMID, BaseUOMCode: row.BaseUOMCode, ScheduledQty: row.ScheduledQty, CompletedReceiptQty: row.CompletedReceiptQty, CompletedReceiptBaseQty: row.CompletedReceiptBaseQty, OverReceiptTolerancePct: row.OverReceiptTolerancePct, UnderReceiptTolerancePct: row.UnderReceiptTolerancePct, UOMID: row.UOMID, UOMCode: row.UOMCode, VendorItemCode: row.VendorItemCode, ExpectedLotNo: row.ExpectedLotNo, ExpectedExpiryDate: expiry, Notes: row.Notes}
}
func mapInboundOrder(row repository.InboundOrderRow) dto.InboundOrderResponse {
	return dto.InboundOrderResponse{ID: row.ID, PurchaseOrderID: row.PurchaseOrderID, OwnerID: row.OwnerID, OwnerCode: row.OwnerCode, VendorID: row.VendorID, VendorCode: row.VendorCode, VendorName: row.VendorName, WarehouseID: row.WarehouseID, WarehouseCode: row.WarehouseCode, BusinessDate: dateText(row.BusinessDate), ExpectedArrivalAt: row.ExpectedArrivalAt, ExternalReference: row.ExternalReference, SupplierReference: row.SupplierReference, StatusCode: row.StatusCode, Notes: row.Notes, SupersedesInboundID: row.SupersedesInboundID, SuccessorInboundID: row.SuccessorInboundID, VersionNo: row.VersionNo, CreatedAt: row.CreatedAt}
}
func mapInboundOrderLine(row repository.InboundOrderLineRow) dto.InboundOrderLineResponse {
	...
	return dto.InboundOrderLineResponse{ID: row.ID, PurchaseOrderLineID: row.PurchaseOrderLineID, LineNo: row.LineNo, ItemID: row.ItemID, ItemCode: row.ItemCode, ItemName: row.ItemName, ExpectedQty: row.ExpectedQty, UOMConversionToBase: row.UOMConversionToBase, ExpectedBaseQty: row.ExpectedBaseQty, BaseUOMID: row.BaseUOMID, BaseUOMCode: row.BaseUOMCode, CompletedReceiptQty: row.CompletedReceiptQty, CompletedReceiptBaseQty: row.CompletedReceiptBaseQty, UOMID: row.UOMID, UOMCode: row.UOMCode, ExpectedLotNo: row.ExpectedLotNo, ExpectedExpiryDate: expiry, CustomerLineReference: row.CustomerLineReference, Notes: row.Notes}
}
func mapReceipt(row repository.ReceiptRow) dto.ReceiptResponse {
	return dto.ReceiptResponse{ID: row.ID, InboundID: row.InboundID, OwnerID: row.OwnerID, OwnerCode: row.OwnerCode, WarehouseID: row.WarehouseID, WarehouseCode: row.WarehouseCode, BusinessDate: dateText(row.BusinessDate), ReceivedAt: row.ReceivedAt, DockLocationID: row.DockLocationID, VehicleNumber: row.VehicleNumber, SealNumber: row.SealNumber, DeliveryNoteNo: row.DeliveryNoteNo, StatusCode: row.StatusCode, Notes: row.Notes, SupersedesReceiptID: row.SupersedesReceiptID, SuccessorReceiptID: row.SuccessorReceiptID, VersionNo: row.VersionNo, CreatedAt: row.CreatedAt}
}
func mapReceiptLine(row repository.ReceiptLineRow) dto.ReceiptLineResponse {
	return dto.ReceiptLineResponse{ID: row.ID, InboundLineID: row.InboundLineID, LineNo: row.LineNo, ItemID: row.ItemID, ItemCode: row.ItemCode, ItemName: row.ItemName, ReceivedQty: row.ReceivedQty, RejectedQty: row.RejectedQty, UOMConversionToBase: row.UOMConversionToBase, ReceivedBaseQty: row.ReceivedBaseQty, RejectedBaseQty: row.RejectedBaseQty, BaseUOMID: row.BaseUOMID, BaseUOMCode: row.BaseUOMCode, ExceptionNotes: row.ExceptionNotes, ExceptionTypeCode: row.ExceptionTypeCode, AcceptedQty: row.AcceptedQty, BatchedQty: row.BatchedQty, UOMID: row.UOMID, UOMCode: row.UOMCode, Batches: make([]dto.ReceiptBatchResponse, 0)}
}
...
func mapInboundException(row repository.InboundExceptionRow) dto.InboundExceptionResponse {
	return dto.InboundExceptionResponse{ID: row.ID, OwnerID: row.OwnerID, WarehouseID: row.WarehouseID, OwnerName: row.OwnerName, WarehouseName: row.WarehouseName, CreatedByDisplayName: row.CreatedByDisplayName, SourceDocumentID: row.SourceDocumentID, SourceLineID: row.SourceLineID, ExceptionTypeCode: row.ExceptionTypeCode, ExpectedQty: row.ExpectedQty, ActualQty: row.ActualQty, VarianceQty: row.VarianceQty, Notes: row.Notes, CreatedAt: row.CreatedAt, CreatedBy: row.CreatedBy}
}

func mapReworkTask(row repository.ReworkTaskRow) dto.ReworkTaskResponse {
	return dto.ReworkTaskResponse{ID: row.ID, QuarantineDispositionID: row.QuarantineDispositionID, QuarantineCaseID: row.QuarantineCaseID, SourceBalanceID: row.SourceBalanceID, OwnerID: row.OwnerID, WarehouseID: row.WarehouseID, ItemID: row.ItemID, ItemCode: row.ItemCode, TaskStatusCode: row.TaskStatusCode, TaskPriorityCode: row.TaskPriorityCode, PlannedQty: row.PlannedQty, CompletedQty: row.CompletedQty, UOMID: row.UOMID, BaseUOMCode: row.BaseUOMCode, AssignedTo: row.AssignedTo, AssignedUsername: row.AssignedUsername, WorkInstructions: row.WorkInstructions, ResultNotes: row.ResultNotes, StartedAt: row.StartedAt, CompletedAt: row.CompletedAt, ReinspectionID: row.ReinspectionID, VersionNo: row.VersionNo, CreatedAt: row.CreatedAt}
}
