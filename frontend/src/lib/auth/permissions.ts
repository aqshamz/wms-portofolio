...
export const PERMISSIONS = {
  ...
  INVENTORY: {
    ...
    MOVE: "INVENTORY.MOVE",
    STATUS_CHANGE: "INVENTORY.STATUS_CHANGE",
...
export const MODULE_ACCESS = {
  ...
  INVENTORY: {
    ...
    IDENTITY: requires(PERMISSIONS.INVENTORY.IDENTITY),
    MOVE: requires(PERMISSIONS.INVENTORY.MOVE),
    STATUS_CHANGE: requires(PERMISSIONS.INVENTORY.STATUS_CHANGE),
    ADJUST: requires(PERMISSIONS.INVENTORY.ADJUST),
    COUNT: requires(PERMISSIONS.INVENTORY.COUNT),
    TRANSFER: requires(PERMISSIONS.INVENTORY.TRANSFER),
  },
  OUTBOUND: {
