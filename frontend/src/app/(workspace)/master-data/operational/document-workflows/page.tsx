...
import { DocumentWorkflowScreen } from "@/features/document-workflows/document-workflow-screen";
import { hasPermission, PERMISSIONS } from "@/lib/auth/permissions";
import { getServerSession } from "@/lib/auth/session";

export const metadata: Metadata = { title: "Document workflows" };

export default async function DocumentWorkflowsPage() {
