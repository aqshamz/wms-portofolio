...
import { PutawayConfigurationScreen } from "@/features/putaway-configuration/putaway-configuration-screen";
import { hasPermission, PERMISSIONS } from "@/lib/auth/permissions";
import { getServerSession } from "@/lib/auth/session";

export const metadata: Metadata = { title: "Putaway configuration" };

export default async function PutawayConfigurationPage() {
